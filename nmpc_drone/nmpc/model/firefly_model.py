...
from nmpc.utils import hexa_tool
import casadi as cs
...
class FireflyModel:
    ...
    def v_dynamics(self):
        ...
        collective_thrust = (self.u1 + self.u2 + self.u3
                             + self.u4 + self.u5 + self.u6)
        ...
        rotm = math_tools.quaternion2rotm(self.q)
    ...
    def q_kinematics(self):
        ...
        dqdt = 0.5*math_tools.otimes(self.q, w_quat_form)
        return dqdt
    ...
    def w_dynamics(self):
        ...
        M_x, M_y, M_z = hexa_tool.hexa_thrust_to_moment(self.Parameter,
                                                        self.u)
