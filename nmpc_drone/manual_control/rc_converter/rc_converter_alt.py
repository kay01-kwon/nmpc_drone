...
class RcConverterAlt:
    def __init__(self, ax_max, ay_max, z_max, psidot_max):
    ...
    def set_throttle_rp_y_rate(self, rc_in):
        ...
        self.z_ref_[2] = self.z_max_*(self.z_max_ *
    ...
    def get_avw_rate(self):
        return self.a_ref_, self.z_ref_, self.wd_ref_[2]